...
- 2026-07-31 — **`glClientActiveTexture` retired (40 → 39) — after manufacturing the coverage that made the measurement mean anything.**
  ...
  - `glTexCoordPointer` drops to 1 reachable site; `glVertexPointer`, `glNormalPointer`, `glEnableClientState`, `glDisableClientState` remain, all in this same bind pair.
