...
decltype(glad_glGetTexParameteriv) glad_glGetTexParameteriv = nullptr;
...
decltype(glad_glVertex2fv) glad_glVertex2fv = nullptr;
...
decltype(glad_glCallLists) glad_glCallLists = nullptr;
decltype(glad_glLightModelf) glad_glLightModelf = nullptr;
decltype(glad_glRasterPos2f) glad_glRasterPos2f = nullptr;
decltype(glad_glRasterPos3f) glad_glRasterPos3f = nullptr;
decltype(glad_glBitmap) glad_glBitmap = nullptr;
decltype(glad_glDrawPixels) glad_glDrawPixels = nullptr;
decltype(glad_glTranslated) glad_glTranslated = nullptr;
decltype(glad_glScaled) glad_glScaled = nullptr;
decltype(glad_glRotated) glad_glRotated = nullptr;
...
int gladLoadGL(void) {
    ...
    glad_glGetTexParameteriv = MakeStubImpl(glad_glGetTexParameteriv);
    ...
    glad_glVertex2fv = MakeStubImpl(glad_glVertex2fv);
    ...
    glad_glCallLists = MakeStubImpl(glad_glCallLists);
    glad_glLightModelf = MakeStubImpl(glad_glLightModelf);
    glad_glRasterPos2f = MakeStubImpl(glad_glRasterPos2f);
    glad_glRasterPos3f = MakeStubImpl(glad_glRasterPos3f);
    glad_glBitmap = MakeStubImpl(glad_glBitmap);
    glad_glDrawPixels = MakeStubImpl(glad_glDrawPixels);
    glad_glTranslated = MakeStubImpl(glad_glTranslated);
    glad_glScaled = MakeStubImpl(glad_glScaled);
    glad_glRotated = MakeStubImpl(glad_glRotated);
